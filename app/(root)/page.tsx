...
import { AnimatePresence, motion, Variants } from 'framer-motion'; // Added 'Variants'
...
// --- ANIMATION VARIANTS (Typed to fix the TS error) ---
...
export default function Home() {
  ...
  return (
    <main ref={mainRef} className="min-h-screen w-full transition-colors duration-300 scroll-smooth relative overflow-x-hidden">
      ...
      {!isLoading && (
        <div className={`w-full ${theme === 'light' ? 'bg-white text-gray-900' : 'bg-black text-white'} transition-colors duration-300 relative`}>
          ...
          {/* --- ENHANCED FLOATING CONTACT BUTTON MENU --- */}
